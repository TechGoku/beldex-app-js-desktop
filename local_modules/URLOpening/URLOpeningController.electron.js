...
class URLOpeningController extends URLOpeningController_Abstract {
  ...
  _override_startObserving () {
    ...
    app.on('will-finish-launching', function () { // ^ we might not need to do this
      setTimeout(function () { // it might be necessary to give everything a moment to get established
        ...
        app.on('launched-duplicatively', function (argv) { // main window listens for this too - and brings itself to forefont…
